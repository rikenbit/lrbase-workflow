...
infile = paste0("data/swissprot_string/", org, "_", v, ".csv")
data = try(read.csv(infile))

if(class(data) != "try-error"){
	if(thr == 150){
		outfile = paste0("data/swissprot_string/", org, "_", v, "_low.csv")
	}
	if(thr == 400){
		outfile = paste0("data/swissprot_string/", org, "_", v, "_mid.csv")
	}
	if(thr == 700){
		outfile = paste0("data/swissprot_string/", org, "_", v, "_high.csv")
	}
	# Filtering
